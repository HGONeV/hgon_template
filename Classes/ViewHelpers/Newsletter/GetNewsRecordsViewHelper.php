...
/**
 * GetNewsRecordsViewHelper
 *
 * @author Maximilian Fäßler <maximilian@faesslerweb.de>
 * @package HGON_HgonTemplate
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 */
class GetNewsRecordsViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper
{

    /**
     * Gets news records of the newsletter
     *
    ...
    static public function renderStatic(array $arguments, \Closure $renderChildrenClosure, RenderingContextInterface $renderingContext)
    {
        ...
        /** @var \HGON\HgonTemplate\Domain\Repository\NewsRepository $newsRepositoryy */
        $newsRepository = $objectManager->get('HGON\\HgonTemplate\\Domain\\Repository\\NewsRepository');
        ...
        if ($hgonNewsletter->getTxHgontemplateNewsSelect() == 2) {
            return $hgonNewsletter->getTxHgontemplateNewsList();
            //===
        }
