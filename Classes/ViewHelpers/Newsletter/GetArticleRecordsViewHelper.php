...
/**
 * GetArticleRecordsViewHelper
 *
 * @author Maximilian Fäßler <maximilian@faesslerweb.de>
 * @package HGON_HgonTemplate
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 */
class GetArticleRecordsViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper
{

    /**
     * Gets article records of the newsletter
     *
    ...
    static public function renderStatic(array $arguments, \Closure $renderChildrenClosure, RenderingContextInterface $renderingContext)
    {
        ...
        /** @var \HGON\HgonTemplate\Domain\Repository\ArticleRepository $articleRepository */
        $articleRepository = $objectManager->get('HGON\\HgonTemplate\\Domain\\Repository\\ArticleRepository');
        ...
        if ($hgonNewsletter->getTxHgontemplateArticleSelect() == 1) {
            return $articleRepository->findByMaxDate($hgonNewsletter->getLastIssueTstamp(), $hgonNewsletter->getTxHgontemplateArticleCount());
        }

        // 2 = show manual selected items
        if ($hgonNewsletter->getTxHgontemplateArticleSelect() == 2) {
            return $hgonNewsletter->getTxHgontemplateArticleList();
            //===
        }
